...
# Example 1
import-teamsToolsauthfile -filename /home/shane/Documents/TeamsToolsAuth/TeamsTools.auth | Connect-teamsTools

# Example 2
$auth = import-teamsToolsauthfile -filename /home/shane/Documents/TeamsToolsAuth/TeamsTools.auth
